    ...
    rsx! {
        div {
            class: if sidebar_collapsed() {
                "w-20 h-screen bg-gray-800 text-white transition-all duration-300 flex flex-col shadow-lg"
            } else {
                "w-64 h-screen bg-gray-800 text-white transition-all duration-300 flex flex-col shadow-lg"
            },
            ...
            div { class: "flex items-center justify-between p-4 border-b border-gray-700",
                ...
                div { class: "flex items-center",
                    ...
                    h2 {
                        class: if sidebar_collapsed() { "hidden" } else { "text-xl font-semibold" },
                        "Motion Dashboard"
                    }
                }
            ...
            nav { class: "flex-1 py-4",
                motion::div {
                    class: if active_section() == "dashboard" {
                        "flex items-center px-4 py-3 text-white bg-blue-600 cursor-pointer"
                    } else {
                        "flex items-center px-4 py-3 text-gray-300 hover:bg-gray-700 cursor-pointer"
                    },
                    ...
                    span {
                        class: if sidebar_collapsed() { "hidden" } else { "text-sm" },
                        "Dashboard"
                    }
                }

                motion::div {
                    class: if active_section() == "analytics" {
                        "flex items-center px-4 py-3 text-white bg-blue-600 cursor-pointer"
                    } else {
                        "flex items-center px-4 py-3 text-gray-300 hover:bg-gray-700 cursor-pointer"
                    },
                ...
                motion::div {
                    class: if active_section() == "reports" {
                        "flex items-center px-4 py-3 text-white bg-blue-600 cursor-pointer"
                    } else {
                        "flex items-center px-4 py-3 text-gray-300 hover:bg-gray-700 cursor-pointer"
                    },
                ...
                motion::div {
                    class: if active_section() == "settings" {
                        "flex items-center px-4 py-3 text-white bg-blue-600 cursor-pointer"
                    } else {
                        "flex items-center px-4 py-3 text-gray-300 hover:bg-gray-700 cursor-pointer"
                    },
